 ...
 */
public class LaunchVPN_remote extends Activity {
    ...
    public static VpnProfile profile = null;
    ...
    protected void startVpnFromIntent() {
        ...
        if (Intent.ACTION_MAIN.equals(action)) {
            ...
            VpnProfile profileToConnect = profile;
        ...
        AlertDialog.Builder builder = dialog.setPositiveButton(android.R.string.ok,
                new OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(LaunchVPN_remote.this, OpenVPNStatusService.class);
