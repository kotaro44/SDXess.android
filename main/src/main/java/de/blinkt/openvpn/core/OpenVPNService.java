...
import a8vg.sdxess.Console;
import a8vg.sdxess.StaticRoutes;
...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    ...
    public static final NetworkSpace mRoutes = new NetworkSpace();
    public static final NetworkSpace mRoutesv6 = new NetworkSpace();
    private Thread mProcessThread = null;
    public static VpnProfile mProfile;
    ...
    private void startOpenVPN() {
        ...
        if (!mOvpn3) {
            ...
            Console.log(ovpnManagementThread);
            StaticRoutes.ovpnManagementThread = ovpnManagementThread;
    ...
    private void addLocalNetworksToRoutes() {
        ...
        for (int i = 0; i < localRoutes.length; i += 3) {
            ...
            addRoute(ipAddr,netMask);
        }
    }


    public void addRoute(String ipAddr, String netMask){
