...
public class ConfigParser {
    ...
    public VpnProfile convertProfile() throws ConfigParseError, IOException{
        return this.convertProfile(null);
    }

    // This method is far too long
    @SuppressWarnings("ConstantConditions")
    public VpnProfile convertProfile(String server) throws ConfigParseError, IOException {
        boolean noauthtypeset = true;
        if( server == null )
            server = CONVERTED_PROFILE;
        VpnProfile np = new VpnProfile(server);
